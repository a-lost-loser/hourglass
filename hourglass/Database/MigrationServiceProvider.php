...
use Hourglass\Database\Console\Migrations\InstallCommand;
use Hourglass\Database\Console\Migrations\MigrateCommand;
use Hourglass\Database\Console\Migrations\RollbackCommand;
use Hourglass\Database\Migrations\DatabaseMigrationRepository;
