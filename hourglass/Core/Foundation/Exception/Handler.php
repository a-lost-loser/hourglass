<?php namespace Hourglass\Core\Foundation\Exception;
...
class Handler extends ExceptionHandler
{
    protected $dontReport = [
        Hourglass\Core\Exception\AjaxException::class,
        Hourglass\Core\Exception\ValidationException::class,
        Hourglass\Core\Exception\ApplicationException::class,
